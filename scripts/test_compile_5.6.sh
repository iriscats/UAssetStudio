...
KMS_FILE="/Users/bytedance/Project/UAssetStudio/script/test_case_5_6/BP_PlayerControllerBase.kms"
...
# OUTPUT_FILE="$OUTDIR/BP_PlayerControllerBase_Modified.uasset"
