...
ASSET_PATH="/Users/bytedance/Project/RogueCore/Content/Game/BP_PlayerControllerBase.uasset"
...
dotnet run --project "$CLI_PROJ" -- decompile "$ASSET_PATH" --mappings "$USMAP_PATH" --ue-version "$UE_VERSION" --outdir "$OUTDIR"
