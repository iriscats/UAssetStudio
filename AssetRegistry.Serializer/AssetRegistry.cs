    ...
    public class AssetRegistry
    {
        ...
        public void Read(byte[] infile)
        {
            ...
            for (uint i = 0; i < EntryCount; i++)
            {
                ...
                fAssetData.ObjectPath   =   FName.DefineDummy(null, StringTable[(int)bs.ReadUInt32()], bs.ReadInt32());
                fAssetData.PackagePath  =   FName.DefineDummy(null, StringTable[(int)bs.ReadUInt32()], bs.ReadInt32());
                fAssetData.AssetClass   =   FName.DefineDummy(null, StringTable[(int)bs.ReadUInt32()], bs.ReadInt32());
                fAssetData.PackageName  =   FName.DefineDummy(null, StringTable[(int)bs.ReadUInt32()], bs.ReadInt32());
                fAssetData.AssetName    =   FName.DefineDummy(null, StringTable[(int)bs.ReadUInt32()], bs.ReadInt32());
        ...
        public byte[] Make()
        {
            ...
            foreach (var fstring in keyValuePairs.Keys)
            {
                if (fstring.Encoding == Encoding.ASCII)
                {
                    ...
                    bs.Write((byte)0x0);
                    bs.Write(CRCGenerator.GenerateHash(fstring, disableCasePreservingHash: false));
                }
                else
                {
