...
ASSET_PATH="/Users/bytedance/Project/UAssetStudio/script/test_case_5_6/WPN_ZipLineGun.uasset"
...
dotnet run --project "$CLI_PROJ" -- verify "$ASSET_PATH" --mappings "$USMAP_PATH" --ue-version VER_UE5_6 --outdir "$OUTDIR"
